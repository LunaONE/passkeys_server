...
// final storageRoot = Directory( Platform.environment['STORAGE_LOCATION'] ?? './'

void main() async {
  print('Configuration: relyingPartyId = $relyingPartyId');
...
ResponseContext _healthCheck(final RequestContext ctx) {
  return (ctx as RespondableContext).withResponse(Response.ok());
}

ResponseContext _landingPage(final RequestContext ctx) {
